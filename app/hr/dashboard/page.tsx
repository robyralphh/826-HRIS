        ...
        <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center min-h-[400px] flex items-center justify-center">
                <div>
                    ...
                    <h2 className="text-xl font-bold text-gray-800 mb-2">Welcome to HR Portal</h2>
                    <p className="text-gray-500 max-w-md mx-auto">
                        Manage employee records, organizational structures, and HR processes from your dedicated dashboard.
                    </p>
                </div>
            </div>
        </div>
