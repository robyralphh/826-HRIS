...
export default function HrLayout({
    ...
    useEffect(() => {
        ...
        if (storedUser) {
            ...
            // Security Check: HR managers or Super Admins
            if (userData.role !== 'HR Manager' && userData.role !== 'Super Admin') {
                router.push("/login");
            }
        } else {
    ...
    const getPageTitle = () => {
        const path = pathname.split('/').pop() || 'HR Dashboard';
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3 border-l pl-6 border-gray-100">
                            <div className="flex flex-col items-end text-right">
                                <span className="text-sm font-bold text-gray-800">{user?.username || 'HR Manager'}</span>
